...
>
> 不挂模块的测试：`tests/test_sot_default_caliber.py` 是 SoT 默认口径（init 缺省推荐 local + 管理侧随仓库提交）的文档静态断言套件，守护 `eo-project-init/SKILL.md`、`references/config.md`、`docs/GUIDE.md`、`README.md` 四文件口径一致。
