...
- [x] AC-5 无多项目数据时（单项目场景）保持原静态 chip，不出现禁用态下拉（锁定：tests/test_board_switcher_style.py#test_lock_single_project_stays_static_chip）

独立复核：通过，2026-08-12，基线 c1cc771
